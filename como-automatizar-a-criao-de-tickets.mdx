...
description: "Configure regras nas pesquisas para que tickets sejam criados automaticamente no Fechamento de Loop quando uma resposta satisfizer os critérios definidos — como nota NPS entre 0 e 6."
---
...
<Step title="Acesse a pesquisa desejada">
...
<Step title="Configure a regra de disparo">
...
<Step title="Salve e publique a pesquisa">
...
<Step title="Acesse o link da pesquisa">
  Abra a pesquisa configurada como se fosse um respondente.
</Step>

<Step title="Responda com uma nota dentro do critério">
...
<Expandable title="Posso configurar mais de uma automação para a mesma pesquisa?">
...
<Expandable title="A automação cria o ticket para respostas já recebidas antes da configuração?">
...
<Expandable title="O que acontece se o contato não estiver cadastrado na plataforma?">
...
<Expandable title="Posso pausar ou desativar uma automação sem excluí-la?">
...
<Card title="Como criar e gerenciar tickets manuais?" icon="ticket" href="/fechamento-de-loop/tickets-manuais" cta="Ver artigo">
