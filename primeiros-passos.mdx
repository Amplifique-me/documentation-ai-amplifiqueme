...
<Columns cols="3">
  ...
  <Card title="4. Ative Fechamento de Loop" href="#4-ative-o-fechamento-de-loop" icon="refresh-cw" horizontal="false">

  </Card>

  <Card title="5. Envie a pesquisa" href="#5-envie-a-pesquisa" icon="send" horizontal="false">

  </Card>

  <Card title="6. Leia os resultados" href="#6-leia-os-primeiros-resultados" icon="bar-chart-2" horizontal="false">
