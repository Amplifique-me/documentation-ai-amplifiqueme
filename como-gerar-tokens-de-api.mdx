...
description: "Os tokens de API são a chave de cada integração na Amplifique.me. Aprenda a criar, nomear e configurar um token vinculado a uma pesquisa e canal específicos para uso em webhooks e integrações externas."
---
...
<Step title="Acesse Integrações → API">
...
<Step title="Selecione a pesquisa e o canal">
  Escolha a pesquisa que será disparada e o canal de envio: **E-mail**, **SMS** ou **WhatsApp**.
</Step>

<Step title="Configure atraso ou agendamento (opcional)">
...
<Step title="Salve e copie a URL gerada">
...
<Expandable title="Preciso criar um token para cada pesquisa ou para cada sistema?">
...
<Expandable title="O que acontece se eu deletar um token que está em uso?">
...
<Expandable title="Posso usar o mesmo token para múltiplos sistemas?">
...
<Card title="Como funcionam as integrações?" icon="plug" href="/integracoes/visao-geral" cta="Ver artigo">
