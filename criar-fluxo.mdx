...
description: "Entenda como o módulo Fechamento de Loop organiza a tratativa de feedbacks em fluxos, tickets, fases e checklists — com automação, dashboard e comunicação com o cliente por e-mail."
---
...
<Columns cols={2}>
  <Card title="Fluxos" icon="git-branch" href="/fechamento-de-loop/como-criar-fluxo" cta="Saiba mais">
    Estruturas que organizam as tratativas. Cada fluxo tem seus usuários, responsável padrão, prazo e fases.
  </Card>
  <Card title="Tickets" icon="ticket" href="/fechamento-de-loop/tickets-manuais" cta="Saiba mais">
    Cada feedback tratado vira um ticket, com histórico completo de ações, e-mails e anotações.
  </Card>
  <Card title="Fases" icon="columns" href="/fechamento-de-loop/como-criar-fluxo" cta="Saiba mais">
    Etapas que o ticket percorre até ser fechado: Pendente, Em Progresso e Fechado.
  </Card>
  <Card title="Automação" icon="zap" href="/fechamento-de-loop/automatizar-tickets" cta="Saiba mais">
...
<Expandable title="O Fechamento de Loop funciona para qualquer tipo de pesquisa?">
...
<Expandable title="Preciso criar tickets manualmente ou pode ser automático?">
...
<Expandable title="O cliente sabe que existe um ticket aberto para ele?">
...
<Expandable title="O módulo Fechamento de Loop está disponível em todos os planos?">
