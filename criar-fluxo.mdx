...
<Columns cols="2">
  <Card title="Fluxos" href="/fechamento-de-loop/como-criar-fluxo" icon="git-branch" cta="Saiba mais" horizontal="false">
    Estruturas que organizam as tratativas. Cada fluxo tem seus usuários, responsável padrão, prazo e fases.
  </Card>

  <Card title="Tickets" href="/fechamento-de-loop/tickets-manuais" icon="ticket" cta="Saiba mais" horizontal="false">
    Cada feedback tratado vira um ticket, com histórico completo de ações, e-mails e anotações.
  </Card>

  <Card title="Fases" href="/fechamento-de-loop/como-criar-fluxo" icon="columns" cta="Saiba mais" horizontal="false">
    Etapas que o ticket percorre até ser fechado: Pendente, Em Progresso e Fechado.
  </Card>

  <Card title="Automação" href="/fechamento-de-loop/automatizar-tickets" icon="zap" cta="Saiba mais" horizontal="false">
