...
description: "Crie fluxos de atendimento no Fechamento de Loop com fases personalizadas, checklists por etapa, responsável padrão e prazo de vencimento automático para os tickets."
---
...
<Step title="Defina vencimento e responsável padrão">
...
<Step title="Configure as fases do fluxo">
...
<Step title="Adicione checklists às fases (opcional)">
...
<Step title="Salve e ative o fluxo">
...
<Expandable title="Posso editar um fluxo depois de criado?">
...
<Expandable title="Posso ter mais de um fluxo na conta?">
...
<Expandable title="O que acontece se eu excluir uma fase que já tem tickets?">
...
<Expandable title="Um usuário sem nível de Fechamento de Loop pode ser adicionado ao fluxo?">
