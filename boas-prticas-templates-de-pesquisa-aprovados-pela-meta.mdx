...
description: >-
  ...
  chance de aprovação pela Meta. Inclui exemplos de mensagens corretas e
  incorretas e dicas para reformular templates rejeitados.
---
## Visão geral
...
<Card title="Como criar e vincular um template HSM?" href="https://ajuda.amplifique.me/como-criar-e-vincular-um-template" icon="message-square" cta="Ver artigo" horizontal="false" target="_self">
