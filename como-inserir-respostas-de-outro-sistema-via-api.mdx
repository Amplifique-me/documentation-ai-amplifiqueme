...
description: "Entenda como inserir respostas coletadas fora da Amplifique.me diretamente na plataforma via API — útil para sistemas legados, pesquisas presenciais e integrações customizadas."
...
<Card title="Documentação da API — Apiary" icon="lucide-code-2" href="https://amplifiqueme.docs.apiary.io/" cta="Ver documentação" target="_blank">
...
<ExpandableGroup>
  <Expandable title="As respostas inseridas via API consomem saldo?">
  ...
  <Expandable title="Qual a diferença entre inserir via API e usar o importador de respostas?">
  ...
  <Expandable title="O que acontece se eu não chamar Ignorar Pesquisa quando o contato fechar sem responder?">
  ...
  <Expandable title="As respostas inseridas aparecem em qual canal nos relatórios?">
...
<Card title="Como importar respostas antigas de pesquisas?" icon="lucide-upload" href="/como-importar-respostas-antigas-de-pesquisas" cta="Ver artigo">
