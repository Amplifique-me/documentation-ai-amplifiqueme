...
<Expandable title="Há retry automático se meu endpoint retornar erro?">
  Sim. A Amplifique.me realiza tentativas de reenvio em caso de falha. Para detalhes sobre a política de retry, consulte a documentação da API em [amplifiqueme.readme.io](https://amplifiqueme.readme.io/).
</Expandable>
...
<Card title="Documentação da API Amplifique.me" icon="code" href="/integracoes/api" cta="Ver documentação">
